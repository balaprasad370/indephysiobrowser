  ...
  return (
    <>
      <div className="flex flex-row min-h-screen ">
        <div className="flex flex-col min-h-screen p-3 w-1/5 dark:bg-slate-900 dark:text-gray-800 justify-between fixed sidebar">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button className="p-2 dark:bg-slate-900">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className="w-5 h-5 fill-current dark:text-slate-50"
                >
            ...
            <div className="items-start justify-start">
              ...
              <span className="flex items-center space-x-1">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="text-xs hover:underline dark:text-slate-400"
                >
                  View profile
                </a>
              </span>
        ...
        <div className="w-4/5 flex justify-start ml-auto">
          <Outlet />
        </div>
      </div>
    </>
