...
const QuizOETReading2 = ({
  ...
  const [type, settype] = useState("oetreadingb");
      ...
      <div className="flex flex-col lg:w-full items-start justify-start md:w-full sm:w-full xs:full w-full text-sm">
        <div className="flex flex-col space-y-4 w-11/12">
          <div className="w-full flex  items-start justify-start flex-col">
            <label className="block font-bold">Context</label>
            ...
            >
              ...
              <SelectContent className="text-black bg-white">
                <SelectItem value={"Email"} className="hover:bg-slate-200">
                  Email
                </SelectItem>
                <SelectItem value={"Memos"} className="hover:bg-slate-200">
                  Memos
                </SelectItem>
                <SelectItem value={"Guidelines"} className="hover:bg-slate-200">
                  Guidelines
                </SelectItem>
                <SelectItem
                ...
                <SelectItem value={"Manuals"} className="hover:bg-slate-200">
                  Manuals
                </SelectItem>
                <SelectItem
                  value={"Internal Reports"}
                  className="hover:bg-slate-200"
                >
                  Internal Reports
                </SelectItem>
                <SelectItem value={"Notices"} className="hover:bg-slate-200">
                  Notices
                </SelectItem>
                <SelectItem
                  value={"Announcements"}
...
export default QuizOETReading2;
