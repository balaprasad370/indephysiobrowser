  ...
  return (
    <div>
      <Link to={link}>
        <div
          className={cn(
            "row-span-1 text-start rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-white border border-gray-200 justify-between flex flex-col space-y-4 min-h-[18rem]",
            className
          )}
        >
            ...
            <div className="absolute top-0 w-full">
              <div className="flex justify-between items-center w- p-3">
                <div
                  onClick={(e) => {
                    e.preventDefault();
                    handleEdit({ title, id, description });
                  }}
                >
                  <FaEdit size={18} />
                </div>
